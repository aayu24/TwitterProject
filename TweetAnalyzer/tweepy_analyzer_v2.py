...
if __name__ == '__main__':
	...
	# time_likes = pd.Series(data=df['retweets'].values, index=df['date']) #index -x axis
	# time_likes.plot(figsize=(16,4), color='r') #create the plot
	# plt.show()

	#To correlate multiple plots
